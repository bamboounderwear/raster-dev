...
function getRandomColor() {
  ...
  // Apply random color to selection and moz-selection
  function applyRandomSelectionColor() {
    var color = getRandomColor();
  
    var styleElement = document.getElementById("selectionStyle");
  
    // If style element is not found, create one
    if (!styleElement) {
      styleElement = document.createElement("style");
      styleElement.id = "selectionStyle";
  ...
  // Attach event listener to selectionchange event
  document.addEventListener("selectionchange", applyRandomSelectionColor);
